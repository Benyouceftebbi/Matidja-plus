...
export const AtandenceDataModel: React.FC<openModelProps> = ({ setOpen, open, teacher ,filter ,setFilter}) => {
  const [selectedDate, setSelectedDate] = useState(new Date());
  
  const levels = ['1AM', '2AM', '3AM'];
        ...
        <ScrollArea className="h-screen pb-20">
          ...
          <div className="bg-background text-foreground p-6 md:p-10">
            <Tabs defaultValue="all">
              ...
              <DailyAtandenceDataTable filter={filter} />
